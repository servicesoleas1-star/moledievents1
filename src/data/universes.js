...
/**
 * The 6 event types Moledi Events supports. Each one has a short overview
 * (image + one-line definition) plus 3 short cards that zoom in further:
 * how it works, who it's for, and why people can trust it.
 */
