...
/**
 * Lets visitors enter an amount and see what they'd actually receive
 * after our commission. The country list comes from the backend; if
 * there's nothing configured yet, the picker just stays empty instead
 * of showing a fake country.
 */
