...
/**
 * A continuously scrolling row of every African country, with the ones
 * we're actually active in shown in color. If none are configured yet,
 * every flag just shows "Bientôt" instead.
 */
