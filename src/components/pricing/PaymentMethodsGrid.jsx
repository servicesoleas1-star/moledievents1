...
/**
 * Shows the payment operators available, split into "live now" and
 * "coming soon". Each logo loads in the background; if it fails to load,
 * we just show the operator's initials instead. Both rows scroll on
 * their own, same style as the country strip above.
 */
