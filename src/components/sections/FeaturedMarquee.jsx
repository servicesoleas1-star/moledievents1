...
/**
 * Preview of what people can create on the platform — just visuals and
 * category labels for now, no made-up dates or numbers. Shown as a row
 * of overlapping tickets to invite people to browse the real catalog.
 */
