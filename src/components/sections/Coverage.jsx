...
/**
 * Shows where we operate: a scrolling strip of country flags and names,
 * plus a second strip with the payment operators people can use.
 */

// Payment operator names styled as little colored chips, using each
// brand's own colors — no logo images needed.
const operatorMarks = [
