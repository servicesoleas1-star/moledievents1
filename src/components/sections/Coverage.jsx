...
function Coverage() {
  ...
  return (
    <section id="couverture" className="relative py-20 sm:py-24 overflow-hidden">
      ...
      <div className="pointer-events-none absolute inset-y-0 left-0 w-16 sm:w-24 bg-gradient-to-r from-ink-50 to-transparent" />
      <div className="pointer-events-none absolute inset-y-0 right-0 w-16 sm:w-24 bg-gradient-to-l from-ink-50 to-transparent" />
    </section>
  );
}
