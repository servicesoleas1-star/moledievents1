...
/**
 * Header used on the interior pages (Tarifs, Confidentialité...) — a
 * simple white bar with a thin bottom border, lighter than the dark
 * navbar on the homepage since there's no hero video behind it here.
 */
