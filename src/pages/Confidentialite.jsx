...
/**
 * The privacy policy page. Content describes what data we actually
 * collect on the platform, not generic boilerplate text. Swapping this
 * for a CMS-driven version later would only mean changing where the
 * content comes from, not the layout below.
 */
