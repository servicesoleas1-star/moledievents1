...
/**
 * The login page: a split-screen layout with a photo slideshow on one
 * side and the sign-in form on the other. "Forgot password" and "sign up"
 * just link out to their own pages — this one only handles checking the
 * email/password against the database.
 *
 * The anonymous visitor_id cookie is created and managed elsewhere; this
 * page only reads it if it's already there, so the backend can link the
 * session to the account once logged in.
 */
