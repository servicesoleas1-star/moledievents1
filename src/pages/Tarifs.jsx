...
/**
 * The pricing and coverage page: rate cards, a fee calculator, the list
 * of countries we support, and the payment methods available. Everything
 * here reads from the data files, so if a list is empty it just shows an
 * empty state instead of fake numbers.
 */
function Tarifs() {
  return (
